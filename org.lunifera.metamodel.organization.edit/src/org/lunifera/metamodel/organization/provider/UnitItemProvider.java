...
/**
 * This is the item provider adapter for a {@link org.lunifera.metamodel.organization.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unit_unitType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unit_unitType_feature", "_UI_Unit_type"),
				 OrganizationPackage.Literals.UNIT__UNIT_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OrganizationPackage.Literals.UNIT__SUB_UNITS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OrganizationPackage.Literals.UNIT__SUB_UNITS,
