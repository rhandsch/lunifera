 ...
 * <ul>
 *   <li>{@link org.lunifera.model.software.impl.FeatureImpl#getBundles <em>Bundles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FeatureImpl extends AbstractSoftwareComponentImpl implements Feature {
	/**
	...
	protected EClass eStaticClass() {
		return SoftwarePackage.Literals.FEATURE;
	}
	...
	public EList<Bundle> getBundles() {
		if (bundles == null) {
			bundles = new EObjectResolvingEList<Bundle>(Bundle.class, this, SoftwarePackage.FEATURE__BUNDLES);
		}
		return bundles;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SoftwarePackage.FEATURE__BUNDLES:
				return getBundles();
		}
