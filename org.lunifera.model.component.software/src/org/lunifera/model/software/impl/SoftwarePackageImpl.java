...
public class SoftwarePackageImpl extends EPackageImpl implements SoftwarePackage {
	 ...
	 * @see org.lunifera.model.software.SoftwarePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		knowledgeContainerSoftwareEClass.getESuperTypes().add(theCommonPackage.getAbsKnowledgeContainer());
		abstractSoftwareComponentEClass.getESuperTypes().add(theCommonPackage.getAbsDescribedClass());
		...
		softwareSetupEClass.getESuperTypes().add(theCommonPackage.getAbsIdentifiedClass());
		notificationStrategyEClass.getESuperTypes().add(theCommonPackage.getAbsIdentifiedClass());
		licenseEClass.getESuperTypes().add(theCommonPackage.getAbsIdentifiedClass());
		...
		initEClass(apiEClass, org.lunifera.model.software.API.class, "API", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAPI_Bundles(), this.getBundle(), null, "bundles", null, 0, -1, org.lunifera.model.software.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
