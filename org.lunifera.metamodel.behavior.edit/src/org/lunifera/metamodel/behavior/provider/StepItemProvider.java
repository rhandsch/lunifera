...
/**
 * This is the item provider adapter for a {@link org.lunifera.metamodel.behavior.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BehaviorPackage.Literals.STEP__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.STEP__SENTENCE);
			childrenFeatures.add(BehaviorPackage.Literals.STEP__PARAMETERS);
			childrenFeatures.add(BehaviorPackage.Literals.STEP__ANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__SENTENCE,
				 BehaviorFactory.eINSTANCE.createStepSentence()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__SENTENCE,
				 BehaviorFactory.eINSTANCE.createActionSentence()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__SENTENCE,
				 BehaviorFactory.eINSTANCE.createContext()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__SENTENCE,
				 BehaviorFactory.eINSTANCE.createExpectation()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__PARAMETERS,
				 BehaviorFactory.eINSTANCE.createStepParameter()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.STEP__ANDS,
