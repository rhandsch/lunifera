 ...
 * <ul>
 *   <li>{@link org.lunifera.metamodel.dsl.entity.entitymodel.impl.LEnumImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LEnumImpl extends LTypeImpl implements LEnum {
	...
	protected EClass eStaticClass() {
		return EntitymodelPackage.Literals.LENUM;
	}
	...
	public EList<LEnumLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<LEnumLiteral>(LEnumLiteral.class, this, EntitymodelPackage.LENUM__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EntitymodelPackage.LENUM__LITERALS:
