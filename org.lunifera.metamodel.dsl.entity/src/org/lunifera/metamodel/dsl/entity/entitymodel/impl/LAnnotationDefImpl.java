 ...
 * <ul>
 *   <li>{@link org.lunifera.metamodel.dsl.entity.entitymodel.impl.LAnnotationDefImpl#isExclude <em>Exclude</em>}</li>
 *   <li>{@link org.lunifera.metamodel.dsl.entity.entitymodel.impl.LAnnotationDefImpl#getAnnotation <em>Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LAnnotationDefImpl extends MinimalEObjectImpl.Container implements LAnnotationDef {
	...
	protected EClass eStaticClass() {
		return EntitymodelPackage.Literals.LANNOTATION_DEF;
	}
	...
	public void setExclude(boolean newExclude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LANNOTATION_DEF__EXCLUDE, oldExclude, exclude));
	}
	...
	public NotificationChain basicSetAnnotation(XAnnotation newAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LANNOTATION_DEF__ANNOTATION, oldAnnotation, newAnnotation);
	...
	public void setAnnotation(XAnnotation newAnnotation) {
		if (newAnnotation != annotation) {
			...
			if (annotation != null)
				msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EntitymodelPackage.LANNOTATION_DEF__ANNOTATION, null, msgs);
			if (newAnnotation != null)
				msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EntitymodelPackage.LANNOTATION_DEF__ANNOTATION, null, msgs);
			msgs = basicSetAnnotation(newAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LANNOTATION_DEF__ANNOTATION, newAnnotation, newAnnotation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EntitymodelPackage.LANNOTATION_DEF__ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntitymodelPackage.LANNOTATION_DEF__EXCLUDE:
				return isExclude();
			case EntitymodelPackage.LANNOTATION_DEF__ANNOTATION:
