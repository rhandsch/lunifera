 ...
 * <ul>
 *   <li>{@link org.lunifera.metamodel.dsl.entity.entity.impl.EntityModelImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link org.lunifera.metamodel.dsl.entity.entity.impl.EntityModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityModelImpl extends MinimalEObjectImpl.Container implements EntityModel
{
  ...
  {
    return EntityPackage.Literals.ENTITY_MODEL;
  }
  ...
  public NotificationChain basicSetPackage(org.lunifera.metamodel.dsl.entity.entity.Package newPackage, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EntityPackage.ENTITY_MODEL__PACKAGE, oldPackage, newPackage);
  ...
  public void setPackage(org.lunifera.metamodel.dsl.entity.entity.Package newPackage)
  {
    if (newPackage != package_)
    {
      ...
      if (package_ != null)
        msgs = ((InternalEObject)package_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EntityPackage.ENTITY_MODEL__PACKAGE, null, msgs);
      if (newPackage != null)
        msgs = ((InternalEObject)newPackage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EntityPackage.ENTITY_MODEL__PACKAGE, null, msgs);
      msgs = basicSetPackage(newPackage, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.ENTITY_MODEL__PACKAGE, newPackage, newPackage));
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, EntityPackage.ENTITY_MODEL__ELEMENTS);
    }
    return elements;
  }
