...
/**
 * Manual modifications go to {org.lunifera.metamodel.dsl.entity.EntityRuntimeModule}
 */
...
public abstract class AbstractEntityRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/lunifera/metamodel/dsl/entity/Entity.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.lunifera.metamodel.dsl.entity.Entity");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("entitymodel");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.lunifera.metamodel.dsl.entity.services.EntityGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.lunifera.metamodel.dsl.entity.serializer.EntitySemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.lunifera.metamodel.dsl.entity.serializer.EntitySyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.lunifera.metamodel.dsl.entity.parser.antlr.EntityParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.lunifera.metamodel.dsl.entity.parser.antlr.EntityAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.lunifera.metamodel.dsl.entity.parser.antlr.internal.InternalEntityLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.lunifera.metamodel.dsl.entity.parser.antlr.internal.InternalEntityLexer> provideInternalEntityLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.lunifera.metamodel.dsl.entity.parser.antlr.internal.InternalEntityLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.lunifera.metamodel.dsl.entity.parser.antlr.internal.InternalEntityLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.lunifera.metamodel.dsl.entity.validation.EntityJavaValidator> bindEntityJavaValidator() {
		return org.lunifera.metamodel.dsl.entity.validation.EntityJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.lunifera.metamodel.dsl.entity.formatting.EntityFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.lunifera.metamodel.dsl.entity.jvmmodel.EntityJvmModelInferrer.class;
	}
