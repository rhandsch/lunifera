...
/**
 * This is the item provider adapter for a {@link org.lunifera.metamodel.entity.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EntityPackage.Literals.ENTITY__SUPER_TYPE);
			childrenFeatures.add(EntityPackage.Literals.ENTITY__FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.ENTITY__SUPER_TYPE,
				 TypesFactory.eINSTANCE.createJvmParameterizedTypeReference()));

		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.ENTITY__FEATURES,
				 EntityFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(EntityPackage.Literals.ENTITY__FEATURES,
				 EntityFactory.eINSTANCE.createOperation()));
	}
