...
public class CommonFactoryImpl extends EFactoryImpl implements CommonFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CommonPackage.EMAIL: return createEmail();
			case CommonPackage.PHONE: return createPhone();
			case CommonPackage.PHONE_COMPANY: return createPhoneCompany();
			case CommonPackage.COUNTRY: return createCountry();
			case CommonPackage.CITY: return createCity();
			case CommonPackage.STATE: return createState();
			case CommonPackage.ADDRESS: return createAddress();
			default:
	 ...
	 * @generated
	 */
	public PhoneCompany createPhoneCompany() {
		PhoneCompanyImpl phoneCompany = new PhoneCompanyImpl();
		return phoneCompany;
	}
	 ...
	 * @generated
	 */
	public EmailType createEmailTypeFromString(EDataType eDataType, String initialValue) {
		EmailType result = EmailType.get(initialValue);
