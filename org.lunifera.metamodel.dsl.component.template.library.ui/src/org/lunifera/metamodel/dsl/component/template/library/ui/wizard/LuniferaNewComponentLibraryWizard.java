...
public class LuniferaNewComponentLibraryWizard extends BasicNewFileResourceWizard {
	private LuniferaNewComponentLibraryWizardPage mainPage;


	public void addPages() {
		mainPage = new LuniferaNewComponentLibraryWizardPage(getSelection());
		addPage(mainPage);
	}
