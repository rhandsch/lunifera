 ...
 * generated by Xtext
 */
package org.lunifera.metamodel.dsl.component.template.library.ui.contentassist;
...
import org.lunifera.metamodel.dsl.component.template.library.ui.contentassist.AbstractComponentTemplateLibraryDslProposalProvider;
 ...
 */
public class ComponentTemplateLibraryDslProposalProvider extends
		AbstractComponentTemplateLibraryDslProposalProvider {
	...
	protected String getDisplayString(EObject element,
		...
		if (qualifiedNameAsString == null) {
			if (element != null)
				qualifiedNameAsString = getLabelProvider().getText(element);
			else
				return null;
		}
		QualifiedName qualifiedName = getQualifiedNameConverter()
				.toQualifiedName(qualifiedNameAsString);
		if (qualifiedName.getSegmentCount() > 1) {
			return qualifiedName.skipFirst(qualifiedName.getSegmentCount() - 3)
