...
public abstract class AbstractJpaSemanticSequencer extends EntitySemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == EntityPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case JpaPackage.JMODEL:
				if(context == grammarAccess.getJModelRule()) {
					sequence_JModel(context, (JModel) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *     jmodel=EntityModel
	 */
	protected void sequence_JModel(EObject context, JModel semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JpaPackage.Literals.JMODEL__JMODEL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JpaPackage.Literals.JMODEL__JMODEL));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJModelAccess().getJmodelEntityModelParserRuleCall_0(), semanticObject.getJmodel());
		feeder.finish();
	}
