...
import org.lunifera.metamodel.dsl.entity.serializer.AbstractEntitySemanticSequencer;
...
public class AbstractJpaSemanticSequencer extends AbstractSemanticSequencer {
	...
	@Inject
	protected Provider<AbstractEntitySemanticSequencer> superSequencerProvider;
	 
	protected AbstractEntitySemanticSequencer superSequencer; 
		...
		if(semanticObject.eClass().getEPackage() == EntityPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case JpaPackage.JPA_ENTITY:
				if(context == grammarAccess.getJPAEntityRule() ||
				   context == grammarAccess.getJPAModelRule()) {
					sequence_JPAEntity(context, (JPAEntity) semanticObject); 
					return; 
				}
				else break;
			case JpaPackage.JPA_PROPERTY:
				if(context == grammarAccess.getJPAModelRule() ||
				   context == grammarAccess.getJPAPropertyRule()) {
					sequence_JPAProperty(context, (JPAProperty) semanticObject); 
					return; 
				}
				else break;
			case JpaPackage.JPA_REFERENCE:
				if(context == grammarAccess.getJPAModelRule() ||
				   context == grammarAccess.getJPAReferenceRule()) {
					sequence_JPAReference(context, (JPAReference) semanticObject); 
					return; 
				}
				else break;
			}
	...
	protected void sequence_JPAEntity(EObject context, JPAEntity semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JpaPackage.Literals.JPA_ENTITY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JpaPackage.Literals.JPA_ENTITY__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJPAEntityAccess().getNameEntityParserRuleCall_0_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *     name=Property
	 */
	protected void sequence_JPAProperty(EObject context, JPAProperty semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JpaPackage.Literals.JPA_PROPERTY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JpaPackage.Literals.JPA_PROPERTY__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJPAPropertyAccess().getNamePropertyParserRuleCall_0_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *     name=Reference
	 */
	protected void sequence_JPAReference(EObject context, JPAReference semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, JpaPackage.Literals.JPA_REFERENCE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, JpaPackage.Literals.JPA_REFERENCE__NAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getJPAReferenceAccess().getNameReferenceParserRuleCall_0_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (modifier=Modifier? type=JvmTypeReference name=ValidID (params+=FullJvmFormalParameter params+=FullJvmFormalParameter*)? body=MyBlockExpression)
	 */
