...
/**
 * Manual modifications go to {org.lunifera.metamodel.dsl.jpa.JpaRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractJpaRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/lunifera/metamodel/dsl/jpa/Jpa.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.lunifera.metamodel.dsl.jpa.Jpa");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("lunjpa");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.lunifera.metamodel.dsl.jpa.services.JpaGrammarAccess.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.lunifera.metamodel.dsl.jpa.parser.antlr.JpaParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.lunifera.metamodel.dsl.jpa.parser.antlr.JpaAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.lunifera.metamodel.dsl.jpa.parser.antlr.internal.InternalJpaLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.lunifera.metamodel.dsl.jpa.parser.antlr.internal.InternalJpaLexer> provideInternalJpaLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.lunifera.metamodel.dsl.jpa.parser.antlr.internal.InternalJpaLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.lunifera.metamodel.dsl.jpa.parser.antlr.internal.InternalJpaLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.lunifera.metamodel.dsl.jpa.validation.JpaJavaValidator> bindJpaJavaValidator() {
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.lunifera.metamodel.dsl.jpa.formatting.JpaFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.lunifera.metamodel.dsl.jpa.jvmmodel.JpaJvmModelInferrer.class;
	}
