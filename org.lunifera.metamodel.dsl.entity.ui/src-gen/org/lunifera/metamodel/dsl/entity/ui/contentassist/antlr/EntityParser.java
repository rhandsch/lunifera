...
* generated by Xtext
*/
package org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr;
...
public class EntityParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr.internal.InternalEntityParser createParser() {
		org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr.internal.InternalEntityParser result = new org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr.internal.InternalEntityParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityMemberAccess().getAlternatives_2(), "rule__EntityMember__Alternatives_2");
					put(grammarAccess.getEntityMemberAccess().getAlternatives_2_0_2(), "rule__EntityMember__Alternatives_2_0_2");
					...
					put(grammarAccess.getLGenSettingsAccess().getGroup(), "rule__LGenSettings__Group__0");
					put(grammarAccess.getLGenSettingsAccess().getGroup_3_1(), "rule__LGenSettings__Group_3_1__0");
					put(grammarAccess.getLCompilerTypeAccess().getGroup(), "rule__LCompilerType__Group__0");
					put(grammarAccess.getLCompilerTypeAccess().getGroup_4(), "rule__LCompilerType__Group_4__0");
					put(grammarAccess.getLEntityAccess().getGroup(), "rule__LEntity__Group__0");
					put(grammarAccess.getLEntityAccess().getGroup_4(), "rule__LEntity__Group_4__0");
					put(grammarAccess.getEntityMemberAccess().getGroup(), "rule__EntityMember__Group__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_0(), "rule__EntityMember__Group_2_0__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_0_6(), "rule__EntityMember__Group_2_0_6__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_0_7(), "rule__EntityMember__Group_2_0_7__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_1(), "rule__EntityMember__Group_2_1__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_1_6(), "rule__EntityMember__Group_2_1_6__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_1_7(), "rule__EntityMember__Group_2_1_7__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_2(), "rule__EntityMember__Group_2_2__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_2_6(), "rule__EntityMember__Group_2_2_6__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_2_7(), "rule__EntityMember__Group_2_2_7__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_3(), "rule__EntityMember__Group_2_3__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_3_5(), "rule__EntityMember__Group_2_3_5__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_4(), "rule__EntityMember__Group_2_4__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_5(), "rule__EntityMember__Group_2_5__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_5_6(), "rule__EntityMember__Group_2_5_6__0");
					put(grammarAccess.getEntityMemberAccess().getGroup_2_5_6_1(), "rule__EntityMember__Group_2_5_6_1__0");
					...
					put(grammarAccess.getLAnnotationDefAccess().getGroup(), "rule__LAnnotationDef__Group__0");
					...
					put(grammarAccess.getLMultiplicityAccess().getGroup_3(), "rule__LMultiplicity__Group_3__0");
					...
					put(grammarAccess.getLEntityModelAccess().getCompilersAssignment_3(), "rule__LEntityModel__CompilersAssignment_3");
					put(grammarAccess.getLEntityModelAccess().getTypesAssignment_4(), "rule__LEntityModel__TypesAssignment_4");
					...
					put(grammarAccess.getLGenSettingsAccess().getNoSourceAssignment_3_0(), "rule__LGenSettings__NoSourceAssignment_3_0");
					put(grammarAccess.getLGenSettingsAccess().getCompilerTypeAssignment_3_1_1(), "rule__LGenSettings__CompilerTypeAssignment_3_1_1");
					put(grammarAccess.getLGenSettingsAccess().getLifecycleAssignment_3_2(), "rule__LGenSettings__LifecycleAssignment_3_2");
					put(grammarAccess.getLGenSettingsAccess().getPropertyChangeSupportAssignment_3_3(), "rule__LGenSettings__PropertyChangeSupportAssignment_3_3");
					put(grammarAccess.getLCompilerTypeAccess().getNameAssignment_2(), "rule__LCompilerType__NameAssignment_2");
					put(grammarAccess.getLCompilerTypeAccess().getDescriptionAssignment_4_1(), "rule__LCompilerType__DescriptionAssignment_4_1");
					put(grammarAccess.getLEntityAccess().getAnnotationsAssignment_0(), "rule__LEntity__AnnotationsAssignment_0");
					put(grammarAccess.getLEntityAccess().getCachableAssignment_1_0(), "rule__LEntity__CachableAssignment_1_0");
					put(grammarAccess.getLEntityAccess().getEmbeddableAssignment_1_1(), "rule__LEntity__EmbeddableAssignment_1_1");
					put(grammarAccess.getLEntityAccess().getNameAssignment_3(), "rule__LEntity__NameAssignment_3");
					put(grammarAccess.getLEntityAccess().getSuperTypeAssignment_4_1(), "rule__LEntity__SuperTypeAssignment_4_1");
					put(grammarAccess.getLEntityAccess().getEntityMembersAssignment_6(), "rule__LEntity__EntityMembersAssignment_6");
					put(grammarAccess.getEntityMemberAccess().getAnnotationsAssignment_1(), "rule__EntityMember__AnnotationsAssignment_1");
					put(grammarAccess.getEntityMemberAccess().getIdAssignment_2_0_2_0(), "rule__EntityMember__IdAssignment_2_0_2_0");
					put(grammarAccess.getEntityMemberAccess().getVersionAssignment_2_0_2_1(), "rule__EntityMember__VersionAssignment_2_0_2_1");
					put(grammarAccess.getEntityMemberAccess().getTransientAssignment_2_0_2_2(), "rule__EntityMember__TransientAssignment_2_0_2_2");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_0_3(), "rule__EntityMember__TypeAssignment_2_0_3");
					put(grammarAccess.getEntityMemberAccess().getMultiplicityAssignment_2_0_4(), "rule__EntityMember__MultiplicityAssignment_2_0_4");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_0_5(), "rule__EntityMember__NameAssignment_2_0_5");
					put(grammarAccess.getEntityMemberAccess().getDefaultValueLiteralAssignment_2_0_6_1(), "rule__EntityMember__DefaultValueLiteralAssignment_2_0_6_1");
					put(grammarAccess.getEntityMemberAccess().getSingularNameAssignment_2_0_7_1(), "rule__EntityMember__SingularNameAssignment_2_0_7_1");
					put(grammarAccess.getEntityMemberAccess().getLazyAssignment_2_1_2_0(), "rule__EntityMember__LazyAssignment_2_1_2_0");
					put(grammarAccess.getEntityMemberAccess().getNotnullAssignment_2_1_2_1(), "rule__EntityMember__NotnullAssignment_2_1_2_1");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_1_3(), "rule__EntityMember__TypeAssignment_2_1_3");
					put(grammarAccess.getEntityMemberAccess().getMultiplicityAssignment_2_1_4(), "rule__EntityMember__MultiplicityAssignment_2_1_4");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_1_5(), "rule__EntityMember__NameAssignment_2_1_5");
					put(grammarAccess.getEntityMemberAccess().getSingularNameAssignment_2_1_6_1(), "rule__EntityMember__SingularNameAssignment_2_1_6_1");
					put(grammarAccess.getEntityMemberAccess().getOppositeAssignment_2_1_7_1(), "rule__EntityMember__OppositeAssignment_2_1_7_1");
					put(grammarAccess.getEntityMemberAccess().getLazyAssignment_2_2_2_0(), "rule__EntityMember__LazyAssignment_2_2_2_0");
					put(grammarAccess.getEntityMemberAccess().getNotnullAssignment_2_2_2_1(), "rule__EntityMember__NotnullAssignment_2_2_2_1");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_2_3(), "rule__EntityMember__TypeAssignment_2_2_3");
					put(grammarAccess.getEntityMemberAccess().getMultiplicityAssignment_2_2_4(), "rule__EntityMember__MultiplicityAssignment_2_2_4");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_2_5(), "rule__EntityMember__NameAssignment_2_2_5");
					put(grammarAccess.getEntityMemberAccess().getSingularNameAssignment_2_2_6_1(), "rule__EntityMember__SingularNameAssignment_2_2_6_1");
					put(grammarAccess.getEntityMemberAccess().getOppositeAssignment_2_2_7_1(), "rule__EntityMember__OppositeAssignment_2_2_7_1");
					put(grammarAccess.getEntityMemberAccess().getLazyAssignment_2_3_2(), "rule__EntityMember__LazyAssignment_2_3_2");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_3_3(), "rule__EntityMember__TypeAssignment_2_3_3");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_3_4(), "rule__EntityMember__NameAssignment_2_3_4");
					put(grammarAccess.getEntityMemberAccess().getOppositeAssignment_2_3_5_1(), "rule__EntityMember__OppositeAssignment_2_3_5_1");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_4_2(), "rule__EntityMember__TypeAssignment_2_4_2");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_4_3(), "rule__EntityMember__NameAssignment_2_4_3");
					put(grammarAccess.getEntityMemberAccess().getModifierAssignment_2_5_1(), "rule__EntityMember__ModifierAssignment_2_5_1");
					put(grammarAccess.getEntityMemberAccess().getTypeAssignment_2_5_3(), "rule__EntityMember__TypeAssignment_2_5_3");
					put(grammarAccess.getEntityMemberAccess().getNameAssignment_2_5_4(), "rule__EntityMember__NameAssignment_2_5_4");
					put(grammarAccess.getEntityMemberAccess().getParamsAssignment_2_5_6_0(), "rule__EntityMember__ParamsAssignment_2_5_6_0");
					put(grammarAccess.getEntityMemberAccess().getParamsAssignment_2_5_6_1_1(), "rule__EntityMember__ParamsAssignment_2_5_6_1_1");
					put(grammarAccess.getEntityMemberAccess().getBodyAssignment_2_5_8(), "rule__EntityMember__BodyAssignment_2_5_8");
					...
					put(grammarAccess.getLAnnotationDefAccess().getExcludeAssignment_0(), "rule__LAnnotationDef__ExcludeAssignment_0");
					put(grammarAccess.getLAnnotationDefAccess().getAnnotationAssignment_1(), "rule__LAnnotationDef__AnnotationAssignment_1");
					put(grammarAccess.getLMultiplicityAccess().getLowerAssignment_2(), "rule__LMultiplicity__LowerAssignment_2");
					put(grammarAccess.getLMultiplicityAccess().getUpperAssignment_3_1(), "rule__LMultiplicity__UpperAssignment_3_1");
					...
					put(grammarAccess.getLGenSettingsAccess().getUnorderedGroup_3(), "rule__LGenSettings__UnorderedGroup_3");
					put(grammarAccess.getLEntityAccess().getUnorderedGroup_1(), "rule__LEntity__UnorderedGroup_1");
					put(grammarAccess.getEntityMemberAccess().getUnorderedGroup_2_1_2(), "rule__EntityMember__UnorderedGroup_2_1_2");
					put(grammarAccess.getEntityMemberAccess().getUnorderedGroup_2_2_2(), "rule__EntityMember__UnorderedGroup_2_2_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr.internal.InternalEntityParser typedParser = (org.lunifera.metamodel.dsl.entity.ui.contentassist.antlr.internal.InternalEntityParser) parser;
			typedParser.entryRuleLEntityModel();
