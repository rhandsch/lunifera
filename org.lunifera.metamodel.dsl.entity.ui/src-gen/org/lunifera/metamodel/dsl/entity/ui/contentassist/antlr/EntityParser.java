		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLReferenceJVMAccess().getAlternatives(), "rule__LReferenceJVM__Alternatives");
					put(grammarAccess.getLMultiplicityAccess().getAlternatives_2_0(), "rule__LMultiplicity__Alternatives_2_0");
					put(grammarAccess.getLMultiplicityAccess().getAlternatives_2_2(), "rule__LMultiplicity__Alternatives_2_2");
					...
					put(grammarAccess.getLEntityAccess().getGroup_2(), "rule__LEntity__Group_2__0");
					put(grammarAccess.getLPropertyAccess().getGroup(), "rule__LProperty__Group__0");
					put(grammarAccess.getLPropertyAccess().getGroup_3(), "rule__LProperty__Group_3__0");
					put(grammarAccess.getLRefersAccess().getGroup(), "rule__LRefers__Group__0");
					put(grammarAccess.getLContainsAccess().getGroup(), "rule__LContains__Group__0");
					put(grammarAccess.getLContainsAccess().getGroup_5(), "rule__LContains__Group_5__0");
					put(grammarAccess.getLContainerAccess().getGroup(), "rule__LContainer__Group__0");
					put(grammarAccess.getLContainerAccess().getGroup_5(), "rule__LContainer__Group_5__0");
					put(grammarAccess.getLRefersJVMAccess().getGroup(), "rule__LRefersJVM__Group__0");
					put(grammarAccess.getLContainsJVMAccess().getGroup(), "rule__LContainsJVM__Group__0");
					put(grammarAccess.getLContainsJVMAccess().getGroup_5(), "rule__LContainsJVM__Group_5__0");
					put(grammarAccess.getLEmbeddsAccess().getGroup(), "rule__LEmbedds__Group__0");
					...
					put(grammarAccess.getLEntityModelAccess().getEntityAssignment_2(), "rule__LEntityModel__EntityAssignment_2");
					...
					put(grammarAccess.getLEntityAccess().getNameAssignment_1(), "rule__LEntity__NameAssignment_1");
					put(grammarAccess.getLEntityAccess().getSuperTypeAssignment_2_1(), "rule__LEntity__SuperTypeAssignment_2_1");
					put(grammarAccess.getLEntityAccess().getEntityMembersAssignment_4(), "rule__LEntity__EntityMembersAssignment_4");
					put(grammarAccess.getLPropertyAccess().getTypeAssignment_1(), "rule__LProperty__TypeAssignment_1");
					put(grammarAccess.getLPropertyAccess().getNameAssignment_2(), "rule__LProperty__NameAssignment_2");
					put(grammarAccess.getLPropertyAccess().getDefaultValueLiteralAssignment_3_1(), "rule__LProperty__DefaultValueLiteralAssignment_3_1");
					put(grammarAccess.getLRefersAccess().getTypeAssignment_2(), "rule__LRefers__TypeAssignment_2");
					put(grammarAccess.getLRefersAccess().getMultiplicityAssignment_3(), "rule__LRefers__MultiplicityAssignment_3");
					put(grammarAccess.getLRefersAccess().getNameAssignment_4(), "rule__LRefers__NameAssignment_4");
					put(grammarAccess.getLContainsAccess().getTypeAssignment_2(), "rule__LContains__TypeAssignment_2");
					put(grammarAccess.getLContainsAccess().getMultiplicityAssignment_3(), "rule__LContains__MultiplicityAssignment_3");
					put(grammarAccess.getLContainsAccess().getNameAssignment_4(), "rule__LContains__NameAssignment_4");
					put(grammarAccess.getLContainsAccess().getOppositeAssignment_5_1(), "rule__LContains__OppositeAssignment_5_1");
					put(grammarAccess.getLContainerAccess().getTypeAssignment_2(), "rule__LContainer__TypeAssignment_2");
					put(grammarAccess.getLContainerAccess().getMultiplicityAssignment_3(), "rule__LContainer__MultiplicityAssignment_3");
					put(grammarAccess.getLContainerAccess().getNameAssignment_4(), "rule__LContainer__NameAssignment_4");
					put(grammarAccess.getLContainerAccess().getOppositeAssignment_5_1(), "rule__LContainer__OppositeAssignment_5_1");
					put(grammarAccess.getLRefersJVMAccess().getTypeAssignment_2(), "rule__LRefersJVM__TypeAssignment_2");
					put(grammarAccess.getLRefersJVMAccess().getMultiplicityAssignment_3(), "rule__LRefersJVM__MultiplicityAssignment_3");
					put(grammarAccess.getLRefersJVMAccess().getNameAssignment_4(), "rule__LRefersJVM__NameAssignment_4");
					put(grammarAccess.getLContainsJVMAccess().getTypeAssignment_2(), "rule__LContainsJVM__TypeAssignment_2");
					put(grammarAccess.getLContainsJVMAccess().getMultiplicityAssignment_3(), "rule__LContainsJVM__MultiplicityAssignment_3");
					put(grammarAccess.getLContainsJVMAccess().getNameAssignment_4(), "rule__LContainsJVM__NameAssignment_4");
					put(grammarAccess.getLContainsJVMAccess().getOppositeAssignment_5_1(), "rule__LContainsJVM__OppositeAssignment_5_1");
					put(grammarAccess.getLEmbeddsAccess().getTypeAssignment_1(), "rule__LEmbedds__TypeAssignment_1");
					put(grammarAccess.getLEmbeddsAccess().getNameAssignment_2(), "rule__LEmbedds__NameAssignment_2");
					put(grammarAccess.getLOperationAccess().getOperationAnnotationAssignment_0(), "rule__LOperation__OperationAnnotationAssignment_0");
					put(grammarAccess.getLOperationAccess().getModifierAssignment_1(), "rule__LOperation__ModifierAssignment_1");
					put(grammarAccess.getLOperationAccess().getTypeAssignment_3(), "rule__LOperation__TypeAssignment_3");
					put(grammarAccess.getLOperationAccess().getNameAssignment_4(), "rule__LOperation__NameAssignment_4");
					put(grammarAccess.getLOperationAccess().getParamsAssignment_6_0(), "rule__LOperation__ParamsAssignment_6_0");
					put(grammarAccess.getLOperationAccess().getParamsAssignment_6_1_1(), "rule__LOperation__ParamsAssignment_6_1_1");
					put(grammarAccess.getLOperationAccess().getBodyAssignment_8(), "rule__LOperation__BodyAssignment_8");
