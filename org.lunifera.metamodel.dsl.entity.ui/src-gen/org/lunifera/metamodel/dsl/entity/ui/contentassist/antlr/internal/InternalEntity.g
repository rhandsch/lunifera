...
:
(
{ before(grammarAccess.getEntityModelAccess().getPackagePackageDeclarationParserRuleCall_0_0()); }
	rulePackageDeclaration{ after(grammarAccess.getEntityModelAccess().getPackagePackageDeclarationParserRuleCall_0_0()); }
)
