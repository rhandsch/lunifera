...
public class EntityHighlightingConfiguration implements
	...
	// { PARAM , PARAM_VAL , VARIABLE , VARIABLE_VAL , STRING , NUMBER , GROUP ,
	// PFT
	// };
	//
	...
	// }
	//
	// public void addType(IHighlightingConfigurationAcceptor acceptor, String
	// s, int r, int g, int b, int style )
	// {
