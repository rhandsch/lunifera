...
//import org.lunifera.metamodel.dsl.jpa.jpamodel.LJPAAnnotation;

public class EntitySemanticHighlightingCalculator implements
	...
	// highlightNode(
	// node,
	// EntityHighlightingConfiguration.ANNOTATION_SPECIAL_KEYWORDS,
	// acceptor);
	...
	// EntityHighlightingConfiguration.ANNOTATION_ID,
	// acceptor);
	// } else if (semanticObject instanceof JvmParameterizedTypeReference) {
	// highlightNode(
	// node,
	// EntityHighlightingConfiguration.ANNOTATION_PARAMS_VALUE,
	// acceptor);
	// } else if (semanticObject instanceof JvmAnnotationValue) {
	// highlightNode(
	// node,
	// EntityHighlightingConfiguration.ANNOTATION_PARAMS_VALUE,
	// acceptor);
	...
	// highlightNode(
	// node,
	// EntityHighlightingConfiguration.ANNOTATION_PARAMS_ID,
	// acceptor);
	// }
	// }
	// }
	...
	// return object instanceof LJPAAnnotation;
	// }
