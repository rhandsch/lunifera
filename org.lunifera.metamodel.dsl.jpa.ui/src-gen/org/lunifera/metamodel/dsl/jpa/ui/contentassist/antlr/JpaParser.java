		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNullableAnnotationAccess().getGroup(), "rule__NullableAnnotation__Group__0");
					put(grammarAccess.getManyToManyAnnotationAccess().getGroup(), "rule__ManyToManyAnnotation__Group__0");
					put(grammarAccess.getManyToManyAnnotationAccess().getGroup_3(), "rule__ManyToManyAnnotation__Group_3__0");
					put(grammarAccess.getManyToManyAnnotationAccess().getGroup_3_1(), "rule__ManyToManyAnnotation__Group_3_1__0");
					...
					put(grammarAccess.getNullableAnnotationAccess().getNameAssignment_2(), "rule__NullableAnnotation__NameAssignment_2");
					put(grammarAccess.getManyToManyAnnotationAccess().getNameAssignment_2(), "rule__ManyToManyAnnotation__NameAssignment_2");
					put(grammarAccess.getManyToManyAnnotationAccess().getTargetEntityAssignment_3_1_0_1(), "rule__ManyToManyAnnotation__TargetEntityAssignment_3_1_0_1");
					put(grammarAccess.getManyToManyAnnotationAccess().getMappedByAssignment_3_1_3(), "rule__ManyToManyAnnotation__MappedByAssignment_3_1_3");
