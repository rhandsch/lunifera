...
* generated by Xtext
*/
package org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr;
...
public class JpaParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr.internal.InternalJpaParser createParser() {
		org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr.internal.InternalJpaParser result = new org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr.internal.InternalJpaParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getReferenceAnnotationAccess().getAlternatives(), "rule__ReferenceAnnotation__Alternatives");
					...
					put(grammarAccess.getCascadeTypeAccess().getAlternatives(), "rule__CascadeType__Alternatives");
					put(grammarAccess.getFetchTypeAccess().getAlternatives(), "rule__FetchType__Alternatives");
					...
					put(grammarAccess.getEmbeddableAnnotAccess().getGroup(), "rule__EmbeddableAnnot__Group__0");
					put(grammarAccess.getCachableAnnotAccess().getGroup(), "rule__CachableAnnot__Group__0");
					put(grammarAccess.getIdAnnotAccess().getGroup(), "rule__IdAnnot__Group__0");
					put(grammarAccess.getNullableAnnotAccess().getGroup(), "rule__NullableAnnot__Group__0");
					put(grammarAccess.getUniqueAnnotAccess().getGroup(), "rule__UniqueAnnot__Group__0");
					put(grammarAccess.getLobAnnotAccess().getGroup(), "rule__LobAnnot__Group__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup(), "rule__ManyToManyAnnot__Group__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup_3(), "rule__ManyToManyAnnot__Group_3__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup_3_1(), "rule__ManyToManyAnnot__Group_3_1__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup_3_2(), "rule__ManyToManyAnnot__Group_3_2__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup_3_3(), "rule__ManyToManyAnnot__Group_3_3__0");
					put(grammarAccess.getManyToManyAnnotAccess().getGroup_3_4(), "rule__ManyToManyAnnot__Group_3_4__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup(), "rule__ManyToOneAnnot__Group__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup_3(), "rule__ManyToOneAnnot__Group_3__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup_3_1(), "rule__ManyToOneAnnot__Group_3_1__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup_3_2(), "rule__ManyToOneAnnot__Group_3_2__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup_3_3(), "rule__ManyToOneAnnot__Group_3_3__0");
					put(grammarAccess.getManyToOneAnnotAccess().getGroup_3_4(), "rule__ManyToOneAnnot__Group_3_4__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup(), "rule__OneToManyAnnot__Group__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup_3(), "rule__OneToManyAnnot__Group_3__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup_3_2(), "rule__OneToManyAnnot__Group_3_2__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup_3_3(), "rule__OneToManyAnnot__Group_3_3__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup_3_4(), "rule__OneToManyAnnot__Group_3_4__0");
					put(grammarAccess.getOneToManyAnnotAccess().getGroup_3_5(), "rule__OneToManyAnnot__Group_3_5__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup(), "rule__OneToOneAnnot__Group__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3(), "rule__OneToOneAnnot__Group_3__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3_1(), "rule__OneToOneAnnot__Group_3_1__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3_2(), "rule__OneToOneAnnot__Group_3_2__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3_3(), "rule__OneToOneAnnot__Group_3_3__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3_4(), "rule__OneToOneAnnot__Group_3_4__0");
					put(grammarAccess.getOneToOneAnnotAccess().getGroup_3_5(), "rule__OneToOneAnnot__Group_3_5__0");
					put(grammarAccess.getParamTargetEntityAccess().getGroup(), "rule__ParamTargetEntity__Group__0");
					put(grammarAccess.getParamMappedByAccess().getGroup(), "rule__ParamMappedBy__Group__0");
					put(grammarAccess.getParamCascadeAccess().getGroup(), "rule__ParamCascade__Group__0");
					put(grammarAccess.getParamFetchAccess().getGroup(), "rule__ParamFetch__Group__0");
					put(grammarAccess.getParamOrphanRemovalAccess().getGroup(), "rule__ParamOrphanRemoval__Group__0");
					...
					put(grammarAccess.getMyBlockExpressionAccess().getGroup(), "rule__MyBlockExpression__Group__0");
					put(grammarAccess.getMyBlockExpressionAccess().getGroup_2(), "rule__MyBlockExpression__Group_2__0");
					...
					put(grammarAccess.getJModelAccess().getJmodelAssignment(), "rule__JModel__JmodelAssignment");
					...
					put(grammarAccess.getEmbeddableAnnotAccess().getNameAssignment_2(), "rule__EmbeddableAnnot__NameAssignment_2");
					put(grammarAccess.getCachableAnnotAccess().getNameAssignment_2(), "rule__CachableAnnot__NameAssignment_2");
					put(grammarAccess.getIdAnnotAccess().getNameAssignment_2(), "rule__IdAnnot__NameAssignment_2");
					put(grammarAccess.getNullableAnnotAccess().getNameAssignment_2(), "rule__NullableAnnot__NameAssignment_2");
					put(grammarAccess.getUniqueAnnotAccess().getNameAssignment_2(), "rule__UniqueAnnot__NameAssignment_2");
					put(grammarAccess.getLobAnnotAccess().getNameAssignment_2(), "rule__LobAnnot__NameAssignment_2");
					put(grammarAccess.getManyToManyAnnotAccess().getNameAssignment_2(), "rule__ManyToManyAnnot__NameAssignment_2");
					put(grammarAccess.getManyToManyAnnotAccess().getTargetEntityAssignment_3_1_1(), "rule__ManyToManyAnnot__TargetEntityAssignment_3_1_1");
					put(grammarAccess.getManyToManyAnnotAccess().getMappedByAssignment_3_2_2(), "rule__ManyToManyAnnot__MappedByAssignment_3_2_2");
					put(grammarAccess.getManyToManyAnnotAccess().getCascadeAssignment_3_3_3(), "rule__ManyToManyAnnot__CascadeAssignment_3_3_3");
					put(grammarAccess.getManyToManyAnnotAccess().getFetchAssignment_3_4_3(), "rule__ManyToManyAnnot__FetchAssignment_3_4_3");
					put(grammarAccess.getManyToOneAnnotAccess().getNameAssignment_2(), "rule__ManyToOneAnnot__NameAssignment_2");
					put(grammarAccess.getManyToOneAnnotAccess().getTargetEntityAssignment_3_1_1(), "rule__ManyToOneAnnot__TargetEntityAssignment_3_1_1");
					put(grammarAccess.getManyToOneAnnotAccess().getMappedByAssignment_3_2_2(), "rule__ManyToOneAnnot__MappedByAssignment_3_2_2");
					put(grammarAccess.getManyToOneAnnotAccess().getCascadeAssignment_3_3_3(), "rule__ManyToOneAnnot__CascadeAssignment_3_3_3");
					put(grammarAccess.getManyToOneAnnotAccess().getFetchAssignment_3_4_3(), "rule__ManyToOneAnnot__FetchAssignment_3_4_3");
					put(grammarAccess.getOneToManyAnnotAccess().getNameAssignment_2(), "rule__OneToManyAnnot__NameAssignment_2");
					put(grammarAccess.getOneToManyAnnotAccess().getTargetEntityAssignment_3_1(), "rule__OneToManyAnnot__TargetEntityAssignment_3_1");
					put(grammarAccess.getOneToManyAnnotAccess().getMappedByAssignment_3_2_1(), "rule__OneToManyAnnot__MappedByAssignment_3_2_1");
					put(grammarAccess.getOneToManyAnnotAccess().getCascadeAssignment_3_3_1(), "rule__OneToManyAnnot__CascadeAssignment_3_3_1");
					put(grammarAccess.getOneToManyAnnotAccess().getFetchAssignment_3_4_1(), "rule__OneToManyAnnot__FetchAssignment_3_4_1");
					put(grammarAccess.getOneToManyAnnotAccess().getOrphanRemovalAssignment_3_5_1(), "rule__OneToManyAnnot__OrphanRemovalAssignment_3_5_1");
					put(grammarAccess.getOneToOneAnnotAccess().getNameAssignment_2(), "rule__OneToOneAnnot__NameAssignment_2");
					put(grammarAccess.getOneToOneAnnotAccess().getTargetEntityAssignment_3_1_1(), "rule__OneToOneAnnot__TargetEntityAssignment_3_1_1");
					put(grammarAccess.getOneToOneAnnotAccess().getClassAssignment_3_1_3(), "rule__OneToOneAnnot__ClassAssignment_3_1_3");
					put(grammarAccess.getOneToOneAnnotAccess().getMappedByAssignment_3_2_2(), "rule__OneToOneAnnot__MappedByAssignment_3_2_2");
					put(grammarAccess.getOneToOneAnnotAccess().getCascadeAssignment_3_3_3(), "rule__OneToOneAnnot__CascadeAssignment_3_3_3");
					put(grammarAccess.getOneToOneAnnotAccess().getOrphanRemovalAssignment_3_4_2(), "rule__OneToOneAnnot__OrphanRemovalAssignment_3_4_2");
					put(grammarAccess.getOneToOneAnnotAccess().getFetchAssignment_3_5_3(), "rule__OneToOneAnnot__FetchAssignment_3_5_3");
					put(grammarAccess.getParamTargetEntityAccess().getTargetEntityAssignment_1(), "rule__ParamTargetEntity__TargetEntityAssignment_1");
					put(grammarAccess.getParamTargetEntityAccess().getClassAssignment_3(), "rule__ParamTargetEntity__ClassAssignment_3");
					put(grammarAccess.getParamMappedByAccess().getMappedByAssignment_1(), "rule__ParamMappedBy__MappedByAssignment_1");
					put(grammarAccess.getParamCascadeAccess().getCascadeAssignment_2(), "rule__ParamCascade__CascadeAssignment_2");
					put(grammarAccess.getParamFetchAccess().getFetchAssignment_2(), "rule__ParamFetch__FetchAssignment_2");
					put(grammarAccess.getParamOrphanRemovalAccess().getOrphanRemovalAssignment_1(), "rule__ParamOrphanRemoval__OrphanRemovalAssignment_1");
					put(grammarAccess.getEntityModelAccess().getPackageAssignment_0(), "rule__EntityModel__PackageAssignment_0");
					...
					put(grammarAccess.getOperationAccess().getParamsAssignment_6_0(), "rule__Operation__ParamsAssignment_6_0");
					put(grammarAccess.getOperationAccess().getParamsAssignment_6_1_1(), "rule__Operation__ParamsAssignment_6_1_1");
					...
					put(grammarAccess.getMyBlockExpressionAccess().getExpressionsAssignment_2_0(), "rule__MyBlockExpression__ExpressionsAssignment_2_0");
					...
					put(grammarAccess.getEntityModelAccess().getUnorderedGroup(), "rule__EntityModel__UnorderedGroup");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr.internal.InternalJpaParser typedParser = (org.lunifera.metamodel.dsl.jpa.ui.contentassist.antlr.internal.InternalJpaParser) parser;
			typedParser.entryRuleJModel();
