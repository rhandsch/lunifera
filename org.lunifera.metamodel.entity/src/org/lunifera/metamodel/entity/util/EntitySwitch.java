...
public class EntitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EntityPackage.KNOWLEDGE_CONTAINER_DOMAIN: {
				...
				if (result == null) result = caseAbstractKnowledgeContainer(knowledgeContainerDomain);
				if (result == null) result = caseAbstractDescribedClass(knowledgeContainerDomain);
				if (result == null) result = caseAbstractNamedClass(knowledgeContainerDomain);
				if (result == null) result = caseAbstractIdentifiedClass(knowledgeContainerDomain);
			...
			case EntityPackage.ABSTRACT_ELEMENT: {
				...
				if (result == null) result = caseAbstractIdentifiedClass(abstractElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EntityPackage.PACKAGE_DECLARATION: {
				...
				if (result == null) result = caseAbstractIdentifiedClass(packageDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntityPackage.ENTITY: {
				...
				if (result == null) result = caseAbstractIdentifiedClass(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EntityPackage.PROPERTY: {
				...
				if (result == null) result = caseAbstractIdentifiedClass(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntityPackage.OPERATION: {
				...
				if (result == null) result = caseAbstractIdentifiedClass(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
