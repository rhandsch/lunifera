 ...
 * <ul>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LGenSettingsImpl#isNoSource <em>No Source</em>}</li>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LGenSettingsImpl#getCompilerType <em>Compiler Type</em>}</li>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LGenSettingsImpl#isLifecycle <em>Lifecycle</em>}</li>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LGenSettingsImpl#isPropertyChangeSupport <em>Property Change Support</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LGenSettingsImpl extends MinimalEObjectImpl.Container implements LGenSettings {
	...
	public LCompilerType getCompilerType() {
		if (compilerType != null && compilerType.eIsProxy()) {
			...
			if (compilerType != oldCompilerType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntitymodelPackage.LGEN_SETTINGS__COMPILER_TYPE, oldCompilerType, compilerType));
			}
		}
		return compilerType;
	}
	...
	public void setCompilerType(LCompilerType newCompilerType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LGEN_SETTINGS__COMPILER_TYPE, oldCompilerType, compilerType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntitymodelPackage.LGEN_SETTINGS__NO_SOURCE:
				return isNoSource();
			case EntitymodelPackage.LGEN_SETTINGS__COMPILER_TYPE:
