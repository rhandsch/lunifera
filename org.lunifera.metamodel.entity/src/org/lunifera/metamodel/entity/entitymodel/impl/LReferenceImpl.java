 ...
 * <ul>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LReferenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.lunifera.metamodel.entity.entitymodel.impl.LReferenceImpl#isLazy <em>Lazy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LReferenceImpl extends LEntityMemberImpl implements LReference {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LREFERENCE__NAME, oldName, name));
	}
	...
	public void setLazy(boolean newLazy) {
		...
		lazy = newLazy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntitymodelPackage.LREFERENCE__LAZY, oldLazy, lazy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntitymodelPackage.LREFERENCE__TYPE:
				...
				return basicGetType();
			case EntitymodelPackage.LREFERENCE__NAME:
				return getName();
			case EntitymodelPackage.LREFERENCE__LAZY:
				return isLazy();
		}
