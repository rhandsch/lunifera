...
import org.lunifera.metamodel.entity.Entity;
import org.lunifera.metamodel.entity.EntityFactory;
import org.lunifera.metamodel.entity.EntityPackage;
import org.lunifera.metamodel.entity.Feature;
import org.lunifera.metamodel.entity.Import;
import org.lunifera.metamodel.entity.KnowledgeContainerDomain;
import org.lunifera.metamodel.entity.Operation;
import org.lunifera.metamodel.entity.PackageDeclaration;
import org.lunifera.metamodel.entity.Property;
...
public class EntityPackageImpl extends EPackageImpl implements EntityPackage {
	 ...
	 * @generated
	 */
	private EClass knowledgeContainerDomainEClass = null;
	 ...
	 * @see org.lunifera.metamodel.entity.EntityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getKnowledgeContainerDomain() {
		return knowledgeContainerDomainEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getKnowledgeContainerDomain_Elements() {
		return (EReference)knowledgeContainerDomainEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getKnowledgeContainerDomain_RelatedSoftwares() {
		return (EReference)knowledgeContainerDomainEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		knowledgeContainerDomainEClass = createEClass(KNOWLEDGE_CONTAINER_DOMAIN);
		createEReference(knowledgeContainerDomainEClass, KNOWLEDGE_CONTAINER_DOMAIN__ELEMENTS);
		createEReference(knowledgeContainerDomainEClass, KNOWLEDGE_CONTAINER_DOMAIN__RELATED_SOFTWARES);
	...
	public void initializePackageContents() {
		...
		knowledgeContainerDomainEClass.getESuperTypes().add(theKnowledgePackage.getAbstractKnowledgeContainer());
		abstractElementEClass.getESuperTypes().add(theCommonPackage.getAbstractIdentifiedClass());
		...
		featureEClass.getESuperTypes().add(theCommonPackage.getAbstractIdentifiedClass());
		propertyEClass.getESuperTypes().add(this.getFeature());
		operationEClass.getESuperTypes().add(this.getFeature());

		// Initialize classes and features; add operations and parameters
		initEClass(knowledgeContainerDomainEClass, KnowledgeContainerDomain.class, "KnowledgeContainerDomain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getKnowledgeContainerDomain_Elements(), this.getAbstractElement(), null, "elements", null, 0, -1, KnowledgeContainerDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getKnowledgeContainerDomain_RelatedSoftwares(), theSoftwarePackage.getAbstractSoftwareComponent(), null, "relatedSoftwares", null, 0, -1, KnowledgeContainerDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
