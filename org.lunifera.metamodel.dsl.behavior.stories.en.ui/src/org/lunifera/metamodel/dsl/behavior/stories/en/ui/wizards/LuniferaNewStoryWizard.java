...
public class LuniferaNewStoryWizard extends BasicNewFileResourceWizard {
	private LuniferaNewStoryWizardPage mainPage;

	public void addPages() {
		mainPage = new LuniferaNewStoryWizardPage(getSelection());
		addPage(mainPage);
	}
