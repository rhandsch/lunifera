...
/**
 * This is the item provider adapter for a {@link org.lunifera.metamodel.software.License} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LicenseItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOpenSourcePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_License_free_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_License_free_feature", "_UI_License_type"),
				 SoftwarePackage.Literals.LICENSE__FREE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Open Source feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOpenSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_License_openSource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_License_openSource_feature", "_UI_License_type"),
				 SoftwarePackage.Literals.LICENSE__OPEN_SOURCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_License_uri_feature", "_UI_License_type"),
				 SoftwarePackage.Literals.LICENSE__URI,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_License_type") + " " + license.isFree();
	}
