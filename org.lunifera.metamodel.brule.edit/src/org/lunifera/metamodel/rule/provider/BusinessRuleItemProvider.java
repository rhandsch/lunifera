...
/**
 * This is the item provider adapter for a {@link org.lunifera.metamodel.rule.BusinessRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_ruleId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_ruleId_feature", "_UI_BusinessRule_type"),
				 RulePackage.Literals.BUSINESS_RULE__RULE_ID,
				 true,
				 false,
				 false,
	...
	protected void addSummaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_summary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_summary_feature", "_UI_BusinessRule_type"),
				 RulePackage.Literals.BUSINESS_RULE__SUMMARY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_body_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_body_feature", "_UI_BusinessRule_type"),
				 RulePackage.Literals.BUSINESS_RULE__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_language_feature", "_UI_BusinessRule_type"),
				 RulePackage.Literals.BUSINESS_RULE__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addServerURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessRule_serverURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessRule_serverURI_feature", "_UI_BusinessRule_type"),
				 RulePackage.Literals.BUSINESS_RULE__SERVER_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
